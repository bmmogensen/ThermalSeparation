...
package N2_H2O_O2 "3 components: N2, H2O, O2"

       constant Integer henry[:] = {1,3};
                        constant SI.Pressure henry_H[:] = {8.51e9,0,4.25e9}
    "Henry coefficient";
    //{8.51e9,0,4.25e9}
     constant Real henry_C[:]={1300,0,1500}
  ...
  extends ThermalSeparation.Media.IdealGasMixtures.BaseClasses.Common;
