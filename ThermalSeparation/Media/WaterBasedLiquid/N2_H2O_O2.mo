...
package N2_H2O_O2 "water: N2, H2O, O2"
...
55.95e-6,
73.37e-6}, omega= { 0.037,
 0.344,
 0.022}, mu = {0, 1.8, 0}, MMX= {0.0280134, 0.01801528, 0.0319988}, eq_Tsonopoulos = {1, 6, 1},
  ...
  p_sat=fill(saturationPressure(T),n);
    ...
    annotation (structurallyIncomplete);
        ...
        redeclare model extends CalcSpecificEnthalpy
          ...
          SI.SpecificHeatCapacity cp_AAS=9.2165*T - 1267.7;

        equation
        /*** enthalpy ***/
        //pT_explicit:
          // h_Jkg =x[2]*cp_solution*(T-0) + (x[1]*21e3); //h_water_Jkg;
          h = (x[2]*cp_water*MM_substances[2] + x[3]*cp_AAS*MM_substances[3])*
                                                                          (T
         - T0) + x[1]*3400*MM_substances[1]*(T - T0);
          //+ x[1]*21e3;
...
redeclare model extends HenryCoefficient
     parameter SI.Pressure henry_H[nSubstance] = {8.51e9,0,4.25e9}
      "Henry coefficient";
     parameter Real henry_C[nSubstance]={1300,0,1500}
