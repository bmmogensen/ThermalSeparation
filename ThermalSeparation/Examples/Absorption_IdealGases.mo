...
ThermalSeparation.Components.SourcesSinks.SourceLiquid
                                              sourceLiquid(
    redeclare package MediumLiquid = ThermalSeparation.Media.WaterBasedLiquid.N2_O2_H2O,T = 323.15,
    x={0,0,1})             annotation (Placement(transformation(extent={{-10,-10},
            {10,10}}, rotation=270,
        origin={6,92})));
ThermalSeparation.Components.SourcesSinks.SinkLiquid
                                            sinkLiquid(redeclare package Medium = ThermalSeparation.Media.WaterBasedLiquid.N2_O2_H2O)  annotation (Placement(transformation(extent={{-10,-10},{
            10,10}},
                   rotation=270,
        origin={7,-30})));

ThermalSeparation.Components.SourcesSinks.SinkGas
                                         sinkGas(      redeclare package    Medium = ThermalSeparation.Media.IdealGasMixtures.N2_H2O_O2, p = 149910)
  ...
  ThermalSeparation.Components.SourcesSinks.SourceGas
    ...
    redeclare package Medium = ThermalSeparation.Media.IdealGasMixtures.N2_H2O_O2,T=417.15,
...
ThermalSeparation.Components.Columns.StructuredPackedColumn column1(
    ...
    redeclare package MediumLiquid = ThermalSeparation.Media.WaterBasedLiquid.N2_O2_H2O, 
    redeclare package MediumVapour = ThermalSeparation.Media.IdealGasMixtures.N2_H2O_O2,
    eps_liq_start=0.02,hasLiquidFeed=false,
    hasVapourFeed=false,
    mapping={{1,1},{2,3},{3,2}},
    nS=3,
    n_elements=10,
